...
<head>
	<meta charset="UTF-8">
    <meta name="description" content="Contact confirmation for Lydell Culture">
    <meta name="keywords" content="Contact confirmation for Lydell Culture">
	<title>Contact Confirmation - Lydell Culture</title>
...
<body>
		...
		<fieldset>
        	...
        	<input type="email" name="verify" id="verify" value="<?php echo $_REQUEST['verify'] ?>" disabled><br>
...
<?php
  ...
  //Set admin email for email to be sent to (use you own MATC email address)
    $admin_email = "johnsonian365@gmail.com"; 
